    ...
    <div className="section-background">
      ...
      <section id="about">
        ...
        <p>
          ...
          characters, deploy devices and cast spells. There are many ways to
          play from building your own deck to playing in a draft tournament for
          up to 8 players. The game plays like a TCG, but without the booster
